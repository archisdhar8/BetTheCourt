...
export function assertActorAllowed(rule: TransitionRule, role: ActorKind | null): void {
...
export function applyTransition(
  ...
  rule: TransitionRule,
  actor: Actor,
  input: { action: TransitionAction; reason?: string; metadata?: Record<string, unknown> },
): void {
  const role = resolveActorRole(challenge, actor);
...
export function assertNotTerminal(challenge: Challenge): void {
