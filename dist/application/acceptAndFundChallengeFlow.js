 ...
 */
export async function acceptAndFundChallengeFlow(deps, input) {
    const actor = { kind: "party", partyId: input.opponentPartyId };
...
//# sourceMappingURL=acceptAndFundChallengeFlow.js.map