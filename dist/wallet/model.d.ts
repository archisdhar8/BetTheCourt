...
export declare const PLATFORM_WALLET_USER_ID = "__platform__";
export declare const LEDGER_ENTRY_TYPES: readonly ["credit", "debit_available", "escrow_lock", "escrow_refund", "escrow_payout_release", "escrow_payout_credit", "platform_fee_credit"];
...
export type WalletErrorCode = "not_found" | "invalid_payload" | "insufficient_funds" | "duplicate_idempotency_key" | "currency_mismatch" | "stake_already_locked" | "challenge_not_escrowable" | "invalid_payout" | "already_paid_out" | "forbidden" | "fraud_payout_blocked";
export declare class WalletDomainError extends Error {
